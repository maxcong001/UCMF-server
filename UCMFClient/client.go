...
// APIClient manages communication with the Nucmf_UECapabilityManagement API v1.0.2
...
type APIClient struct {
	...
	ADictionaryEntryDocumentApi *ADictionaryEntryDocumentApiService

	DicEntryIdDocumentApi *DicEntryIdDocumentApiService

	DictionaryEntryStoreApi *DictionaryEntryStoreApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.ADictionaryEntryDocumentApi = (*ADictionaryEntryDocumentApiService)(&c.common)
	c.DicEntryIdDocumentApi = (*DicEntryIdDocumentApiService)(&c.common)
	c.DictionaryEntryStoreApi = (*DictionaryEntryStoreApiService)(&c.common)
