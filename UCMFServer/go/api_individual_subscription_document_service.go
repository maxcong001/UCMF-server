...
// IndividualSubscriptionDocumentApiService is a service that implents the logic for the IndividualSubscriptionDocumentApiServicer
...
func (s *IndividualSubscriptionDocumentApiService) DeleteIndividualSubcription(ctx context.Context, subscriptionId string) (ImplResponse, error) {
	// TODO - update DeleteIndividualSubcription with the required logic for this service method.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("DeleteIndividualSubcription method not implemented")
}
